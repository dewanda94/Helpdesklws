...
public class LoginActivity extends AppCompatActivity implements OnClickListener {
    ...
    private Button MintaKode, LoginHome, Resend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SetKode = findViewById(R.id.setkode);
        MintaKode = findViewById(R.id.mintakode);
        MintaKode.setOnClickListener(this);
        LoginHome = findViewById(R.id.login);
        ...
        stateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                //Mendeeteksi Apakah Ada User Yang Sedang com.dewanda.helloword.Login (Belum Logout)
                if (user != null) {
                    //Jika Ada, User Tidak perlu com.dewanda.helloword.Login Lagi, dan Langsung Menuju Acivity Yang Dituju
